...
void multigraph()
{
  ...
  const Int_t n1 = 10;
   ...
   Double_t py1[] = {0.014,0.015,0.004,0.0018,0.001,0.0004,0.00028,0.00018,0.00005,0.000003};
...
const Int_t n2 = 10;
   ...
   Double_t py2[] = {0.126,0.14,0.04,0.016,0.009,0.004,0.002,0.0017,0.00047,0.000027};
...
const Int_t n3 = 10;
   ...
   Double_t py3[] = {1.1,1.1,0.32,0.125,0.072,0.032,0.016,0.013,0.0037,0.0002};
