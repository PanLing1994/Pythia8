...
void multigraph()
{
  ...
  const Int_t n1 = 10;
   ...
   Double_t py1[] = {0.075,0.088,0.021,0.013,0.0066,0.0033,0.002,0.001,0.0004,0.00008};
...
const Int_t n2 = 10;
   ...
   Double_t py2[] = {0.375,0.44,0.11,0.065,0.033,0.015,0.01,0.005,0.002,0.0004};
...
const Int_t n3 = 10;
   ...
   Double_t py3[] = {2.63,3.1,0.77,0.46,0.23,0.11,0.07,0.035,0.014,0.0028};
