...
void multigraph()
{
  ...
  const Int_t n1 = 10;
   ...
   Double_t py1[] = {0.026,0.049,0.019,0.008,0.004,0.002,0.001,0.0007,0.0002,0.00003};
...
const Int_t n2 = 10;
   ...
   Double_t py2[] = {0.3,0.56,0.22,0.09,0.049,0.026,0.014,0.008,0.003,0.00026};
...
const Int_t n3 = 10;
   ...
   Double_t py3[] = {2.35,4.46,1.73,0.7,0.39,0.2,0.112,0.06,0.02,0.002};
...
auto leg = new TLegend(.1,.7,.3,.9,"molecule structure #D0#bar{D}^{*}");
leg->SetFillColor(0);
