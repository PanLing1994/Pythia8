...
void multigraph()
{
  ...
  const Int_t n1 = 10;
   ...
   Double_t py1[] = {0.0112,0.0224,0.01,0.005,0.003,0.0017,0.001,0.0007,0.0002,0.000045};
...
const Int_t n2 = 10;
   ...
   Double_t py2[] = {0.157,0.31,0.14,0.07,0.04,0.024,0.014,0.0096,0.0031,0.00063};
...
const Int_t n3 = 10;
   ...
   Double_t py3[] = {1.06,2.1,0.95,0.475,0.285,0.16,0.095,0.066,0.02,0.0043};
