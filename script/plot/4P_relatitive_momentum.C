...
Double_t py1[] = {0.00,0.0035,0.04,0.1,0.4,0.8,1.3,1.9,2.4,3.7,4.9,7.3,8.6,10,12.5,15.9};
...
Double_t py2[] = {0.00,0.0174,0.0174,0.0174,0.13,0.13,0.39,0.91,1.95,3,4.03,5.07,6,7.67,9.1,10.53};
