...
void multigraph()
{
  ...
  const Int_t n1 = 10;
   ...
   Double_t py1[] = {0.015,0.016,0.003,0.0013,0.0007,0.00032,0.0002,0.00015,0.00003,0.000002};
...
const Int_t n2 = 10;
   ...
   Double_t py2[] = {0.045,0.048,0.009,0.004,0.0021,0.001,0.0006,0.00045,0.00009,0.000006};
...
const Int_t n3 = 10;
   ...
   Double_t py3[] = {0.5,0.53,0.099,0.044,0.022,0.011,0.0066,0.005,0.001,0.000066};
...
auto leg = new TLegend(.1,.7,.3,.9,"molecule structure #Sigma_{c}^{+}#bar{D}*^{0}");
leg->SetFillColor(0);
