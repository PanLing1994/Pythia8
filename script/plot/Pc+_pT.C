...
void multigraph()
{
  ...
  const Int_t n1 = 7;
   ...
   Double_t py1[] = {21.5,9.2,2.76,1.25,0.6,0.3,0.1};
   ...
   Double_t py2[] = {6.7,2.5,0.62,0.31,0.14,0.06,0.03};
...
const Int_t n3 = 7;
   ...
   Double_t py3[] = {5.7,2.4,0.83,0.31,0.2,0.06,0.03};
...
leg->SetFillColor(0);
leg->AddEntry(gr1,"P_{c}(4312)^{+}");
leg->AddEntry(gr2,"P_{c}(4440)^{+}");
