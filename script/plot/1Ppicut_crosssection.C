...
void multigraph()
{
  ...
  const Int_t n1 = 10;
   ...
   Double_t py1[] = {0.025,0.049,0.0158,0.008,0.005,0.0027,0.0011,0.00085,0.00027,0.00004};
...
const Int_t n2 = 10;
   ...
   Double_t py2[] = {0.05,0.097,0.037,0.016,0.01,0.0054,0.0022,0.0017,0.00054,0.00008};
...
const Int_t n3 = 10;
   ...
   Double_t py3[] = {0.266,0.51,0.195,0.09,0.052,0.028,0.012,0.009,0.0029,0.00045};
