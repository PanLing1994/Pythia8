...
void multigraph()
{
  ...
  const Int_t n1 = 10;
   ...
   Double_t py1[] = {0.015,0.015,0.0037,0.0017,0.0008,0.00045,0.00025,0.00015,0.00005,0.000007};
...
const Int_t n2 = 10;
   ...
   Double_t py2[] = {0.26,0.27,0.066,0.03,0.015,0.008,0.005,0.0026,0.00081,0.00014};
...
const Int_t n3 = 10;
   ...
   Double_t py3[] = {1.34,1.36,0.34,0.156,0.078,0.041,0.024,0.014,0.004,0.0007};
